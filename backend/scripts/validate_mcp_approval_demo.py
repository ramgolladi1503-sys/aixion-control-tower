...
def main() -> None:
    ...
    pending_before = get(f"/mcp-gateway/pending-requests?approval_request_id={approval_id}")
    ...
    resolved = post(f"/mcp-gateway/approvals/{approval_id}/resolve")
    ...
    pending_after = get(f"/mcp-gateway/pending-requests?approval_request_id={approval_id}")
    ...
    second_resolve = post(f"/mcp-gateway/approvals/{approval_id}/resolve")
